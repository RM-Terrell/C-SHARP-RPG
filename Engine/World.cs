...
namespace Engine
{
    public static class World
    {
        ...
        {
            Items.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "Rusty sword", "Rusty swords", 1, 0, 5));
            ...
            Items.Add(new Weapon(ITEM_ID_CLUB, "Club", "Clubs", 1, 3, 10));
            Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 1, 5));
